...
public class OrdnerDateienAnlegen {
    public OrdnerDateienAnlegen() {
        ausgabe();
    }

    public void ordnerAnlegen(String ordnerPfad) {
    ...
    public void listeOrdner(String pfad) {
